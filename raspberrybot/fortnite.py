...
print(f'\n A free lobbybot server, managed by Raspbery.\n')
...
with open('config.json') as f:
    try:
        ...
        print(Fore.RED + ' [ERROR] ' + Fore.RESET + "There was an error in one of the bot's files! (config.json). If you have problems trying to fix it, please try again!")
...
with open('info.json') as f:
    try:
        ...
        print(Fore.RED + ' [ERROR] ' + Fore.RESET + "There was an error in one of the bot's files! (info.json) If you have problems trying to fix it, try again!")
        print(Fore.LIGHTRED_EX + f'\n {e}')
        exit(1)
...
async def event_ready():
    os.system('cls||clear')
    print(intro)
    print(Fore.GREEN + ' [+] ' + Fore.RESET + 'Bot ready as ' + Fore.LIGHTGREEN_EX + f'{client.user.display_name}')
    print(Fore.GREEN + ' [+] ' 'Share this bot with your friends! ')
